    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 grid place-items-center shadow-lg shadow-indigo-500/30">
            <svg width="15" height="15" viewBox="0 0 13 13" fill="none">
              <path d="M6.5 1L12 3.5v6L6.5 12 1 9.5v-6L6.5 1Z" fill="white" opacity="0.85"/>
              <circle cx="6.5" cy="6.5" r="2" fill="white"/>
            </svg>
          </div>
          <span className="text-white font-bold text-sm tracking-tight">AssistFlow</span>
        </div>
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-white text-[2.6rem] font-bold leading-[1.1] tracking-tight mb-5">
          ...
          <p className="text-zinc-500 text-base leading-relaxed max-w-xs">
            Give every business their own voice-enabled AI agent — trained on their docs, isolated from others.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 px-8">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-10 lg:hidden">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 grid place-items-center">
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <path d="M6.5 1L12 3.5v6L6.5 12 1 9.5v-6L6.5 1Z" fill="white" opacity="0.85"/>
                <circle cx="6.5" cy="6.5" r="2" fill="white"/>
              </svg>
            </div>
            <span className="font-bold text-sm text-zinc-900 dark:text-white">AssistFlow</span>
          </div>
          ...
          <motion.button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-200 text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
