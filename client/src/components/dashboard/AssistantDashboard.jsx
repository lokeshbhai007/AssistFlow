      ...
      >
        ...
        <motion.div variants={fadeUp} className="mb-8 flex justify-between">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${a.isSetupComplete ? "bg-emerald-500" : "bg-amber-400"}`}
              />
              {a.isSetupComplete ? "Live" : "Setup incomplete"}
            </span>
            <Badge
              className={`${a.plan === "pro" ? "bg-indigo-100 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-500"}`}
            >
              {a.plan} plan
            </Badge>
          </div>
        ...
        <motion.div variants={fadeUp} className="grid grid-cols-3 gap-3 mb-6">
          <Stat
            label="Messages sent"
            value={a.totalMessages.toLocaleString()}
          />
          <Stat label="Request limit" value={a.requestLimit.toLocaleString()} />
        ...
        >
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs">
              ...
              <Badge
                className={
                  TONE_COLOR[a.assistantTone] || "bg-zinc-100 text-zinc-500"
                }
              >
                {a.assistantTone}
              </Badge>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <Badge
                className={THEME_COLOR[a.theme] || "bg-zinc-100 text-zinc-500"}
              >
                {a.theme}
              </Badge>
            </div>
            ...
            {[
              ...
              >
                ...
                <span
                  className={`font-semibold ${val ? "text-emerald-500" : "text-zinc-400"}`}
                >
                  {val ? "On" : "Off"}
                </span>
              </div>
          ...
          >
            ...
            <div className="space-y-2">
              {a.pages.map((pg, i) => (
                ...
                >
                  <span className="font-mono text-indigo-500 text-xs mt-0.5 shrink-0">
                    {pg.path}
                  </span>
